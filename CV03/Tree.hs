...
find x (Node left value right)  | x == value = True
                                | x < value = find x left    -- takto je to spravne
                                | x > value = find x right    -- takto je to spravne

-- toto bola nachytavka na prednaske         | x < value = find x right
-- toto bola nachytavka na prednaske         | x > value = find x left
{--
